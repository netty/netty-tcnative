...
MUSL_COMPAT_SYMS='__getauxval fopen64 __isinf __isnan __strdup __libc_single_threaded __isoc23_strtol __isoc23_strtoul __isoc23_strtoull _dl_find_object'
